...
Unlike other iOS groestlcoin wallets, breadwallet is a real standalone bitcoin
client. There is no server to get hacked or go down, so you can always access
your money. Using
[SPV](https://en.bitcoin.it/wiki/Thin_Client_Security#Header-Only_Clients)
mode, breadwallet connects directly to the groestlcoin network with the fast
performance you need on a mobile device.

**the next step in wallet security:**

groestlwallet is designed to protect you from malware, browser security holes,
...
broken.  Because groestlwallet is  
